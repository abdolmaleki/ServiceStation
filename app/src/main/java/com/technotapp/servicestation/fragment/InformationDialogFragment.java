...
public class InformationDialogFragment extends DialogFragment implements View.OnClickListener {
    @BindView(R.id.fragment_dialog_info_text)
    TextView textView;
    @BindView(R.id.fragment_dialog_info_button)
    Button button;
    String message;
    ...
    private void initView() {
        try {
            ...
            AppMonitor.reportBug(e, "InformationDialogFragment", "initView");
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.fragment_dialog_info_button) {
            dismiss();
        }
    }
    ...
    public void show(Activity activity, String message) {
        try {
            setCancelable(false);
            show(activity.getFragmentManager(), "information");
            this.message = message;
        } catch (Exception e) {
            AppMonitor.reportBug(e, "InformationDialogFragment", "show");
        }
    }
}
