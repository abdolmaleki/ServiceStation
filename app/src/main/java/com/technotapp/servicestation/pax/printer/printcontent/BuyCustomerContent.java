...
public class BuyCustomerContent extends Printable {
    @Override
    public Bitmap getContent(Context ctx, String... contents) {
        ...
        page.addLine();
        page.addLine().addUnit(Converters.convertEnDigitToPersian(contents[7]), FONT_SMALL, IImgProcessing.IPage.EAlign.LEFT).addUnit(textToBitmap("انصار"), IImgProcessing.IPage.EAlign.RIGHT); //card no
