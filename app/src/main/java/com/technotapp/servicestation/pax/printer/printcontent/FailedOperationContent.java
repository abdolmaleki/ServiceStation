...
public class FailedOperationContent extends Printable {
    @Override
    public Bitmap getContent(Context ctx, String... contents) {
        ...
        page.addLine();
        page.addLine().addUnit(Converters.ConvertTextToHighlitedText("خرید/رسید مشتری", 24.0f), IImgProcessing.IPage.EAlign.CENTER);
        page.addLine();
        ...
        page.addLine();
        page.addLine().addUnit("عملیات ناموفق", FONT_NORMAL, IImgProcessing.IPage.EAlign.CENTER);
        page.addLine().addUnit(" ", FONT_NORMAL, IImgProcessing.IPage.EAlign.CENTER);
        page.addLine().addUnit("مشتری گرامی در صورت کسر شدن مبلغ، حداکثر تا سه روز آینده به حساب شما باز می گردد", FONT_SMALL, IImgProcessing.IPage.EAlign.CENTER);
        page.addLine();
        page.addLine().addUnit(" ", FONT_NORMAL, IImgProcessing.IPage.EAlign.CENTER);
        page.addLine().addUnit(BitmapFactory.decodeResource(ctx.getResources(), R.drawable.ic_dash_line), IImgProcessing.IPage.EAlign.CENTER);
        page.addLine();
